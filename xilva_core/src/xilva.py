...
class QtPose(object):
    ...
    def load_default(self, _which = dev_name):
        ...
        utils.set_zeros(self._default, _DRIVEUNITS)
        utils.set_zeros(self._payload, _DRIVEUNITS)
...
class MainWindow(QMainWindow):
    def __init__(self, parent=None):
        ...
        utils.set_zeros(self.sld, _DRIVEUNITS)
        utils.set_zeros(self.sldh, _DRIVEUNITS)
        utils.set_zeros(self.sldl, _DRIVEUNITS)
        utils.set_zeros(self.sldn, _DRIVEUNITS)
        utils.set_zeros(self.sldr, _DRIVEUNITS)
        utils.set_zeros(self.labels, _DRIVEUNITS)
        utils.set_zeros(self.fb_value, _DRIVEUNITS)
        ...
        self.expression = []
        # obtain expressions
        param_config = utils.read_param(dev_name, 'behaviors')
...
class ButtomWidget(QWidget):
    def __init__(self, parent):
        ...
        utils.set_zeros(self.cur_value, _DRIVEUNITS)
        
        utils.set_zeros(self.current_labels, _DRIVEUNITS)
        utils.set_zeros(self.current_values, _DRIVEUNITS)
